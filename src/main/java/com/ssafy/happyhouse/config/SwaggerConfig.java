...
//	http://localhost:80/swagger-ui.html
	...
	private String title = "happy API " + version;
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes())
				...
				.apis(RequestHandlerSelectors.basePackage("com.ssafy.happyhouse.controller")).paths(postPaths()).build()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title)
				.description("<h3>SSAFY API Reference for Developers</h3>Swagger를 이용한 happyhouse<br>")
